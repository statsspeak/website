  ...
  const caseStudies = [
    {
      ...
      description:
        "Built an AI-powered sales forecasting system that improved inventory management and reduced stockouts by 40%.",
      challenge:
        "RetailMax was struggling with inventory management, leading to frequent stockouts and overstock situations that affected profitability.",
      solution:
        "We developed a machine learning platform that analyzes historical sales data, seasonal trends, and external factors to predict demand accurately.",
      results: [
    ...
    },
    {
      ...
      description:
        "Implemented a real-time data pipeline processing millions of logistics events daily for operational insights.",
      challenge:
        "LogisticsPro needed real-time visibility into their supply chain operations across multiple countries in East Africa.",
      solution:
        "We built a scalable data engineering platform using Apache Kafka and Spark to process logistics data in real-time.",
      results: [
    ...
    },
    {
      ...
      description:
        "Developed a comprehensive mobile application for farmers to manage crops, track weather, and optimize yields.",
      challenge:
        "Small-scale farmers in Kenya lacked access to modern tools for crop management and weather monitoring.",
      solution:
        "We created a user-friendly mobile app with offline capabilities, weather integration, and yield prediction features.",
      results: [
    ...
    },
    {
      ...
      description:
        "Created an advanced GIS platform for tracking wildlife movements and managing conservation efforts across national parks.",
      challenge:
        "Wildlife tracking and conservation efforts were hampered by lack of centralized data and real-time monitoring capabilities.",
      solution:
        "We developed a comprehensive GIS platform with GPS tracking, satellite imagery analysis, and predictive modeling.",
      results: [
    ...
    },
    {
      ...
      description:
        "Built an automated credit scoring system that reduced loan default rates and streamlined approval processes.",
      challenge:
        "High default rates and manual loan approval processes were affecting the microfinance institution's growth.",
      solution:
        "We developed an ML-based credit scoring system using alternative data sources and behavioral analytics.",
      results: [
    ...
    },
    {
      ...
      description:
        "Implemented an intelligent traffic management system using IoT sensors and predictive analytics.",
      challenge:
        "Severe traffic congestion in Nairobi was causing economic losses and reduced quality of life.",
      solution:
        "We deployed IoT sensors and created a real-time traffic optimization system with predictive routing.",
      results: [
