...
import { ArrowRight, PlayCircle, CheckCircle, Users, Award, Clock, Star, TrendingUp, Globe, Shield } from 'lucide-react';
...
export function HomePage({ onPageChange }: HomePageProps) {
  ...
  const services = [
    {
      ...
      description: 'Transform raw data into actionable business insights with advanced analytics and machine learning solutions.',
      image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop',
      features: ['Predictive Analytics', 'Machine Learning', 'Statistical Modeling', 'Business Intelligence']
    },
    {
      title: 'Data Engineering',
      description: 'Build robust data pipelines and infrastructure for scalable data processing and real-time analytics.',
      image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400&fit=crop',
      features: ['ETL Pipelines', 'Data Warehousing', 'Cloud Architecture', 'Real-time Processing']
    },
    {
    ...
    },
    {
      ...
      description: 'Leverage location-based data for mapping, spatial analysis, and location intelligence solutions.',
      image: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=600&h=400&fit=crop',
      features: ['GIS Solutions', 'Spatial Analysis', 'Remote Sensing', 'Location Intelligence']
    }
  ];

  const stats = [
    { icon: Users, value: '100+', label: 'Projects Completed', color: 'text-primary-blue' },
    { icon: Award, value: '50+', label: 'Happy Clients', color: 'text-medium-blue' },
    { icon: Clock, value: '5+', label: 'Years Experience', color: 'text-primary-blue-dark' },
    { icon: CheckCircle, value: '99%', label: 'Success Rate', color: 'text-primary-blue' }
  ];
  ...
  const directors = [
    {
      ...
      specialties: ['Machine Learning', 'Statistical Modeling', 'Big Data Analytics', 'AI Strategy'],
      linkedin: '#'
    },
    {
      ...
      specialties: ['Cloud Architecture', 'Data Engineering', 'DevOps', 'System Design'],
      linkedin: '#'
    },
    {
      ...
      specialties: ['GIS Development', 'Remote Sensing', 'Spatial Analysis', 'Research'],
      linkedin: '#'
    }
  ];
  ...
  const testimonials = [
    {
      quote: "Statsspeak transformed our health data systems and helped us make evidence-based decisions that save lives.",
    ...
    {
      quote: "Their geospatial solutions revolutionized our wildlife conservation efforts across Kenya's national parks.",
    ...
    {
      quote: "Professional, innovative, and delivered beyond our expectations. Statsspeak is our trusted technology partner.",
      author: "Anne Kananu",
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 xl:py-32 min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-medium-blue/25 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="absolute top-1/4 right-1/4 w-3 h-24 bg-gradient-to-b from-medium-blue/50 to-transparent rotate-12 animate-glowing-lines" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-1/4 left-1/4 w-2 h-20 bg-gradient-to-b from-primary-blue/40 to-transparent rotate-75 animate-glowing-lines" style={{ animationDelay: '3s' }}></div>
        </div>
          ...
          <div className="flex items-center justify-center min-h-[80vh]">
            <div className="text-center space-y-8 xl:space-y-10 2xl:space-y-12 max-w-5xl">
              <div className="inline-flex items-center px-4 py-2 bg-white/95 rounded-full border border-primary-blue/30 shadow-lg backdrop-blur-sm">
                ...
                <span className="text-sm font-medium text-primary-blue">Trusted by 50+ Organizations</span>
              </div>
              
              <h1 className="text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold leading-tight">
                <span className="block text-white drop-shadow-xl" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.8)' }}>Unlocking Insights,</span>
                <span className="block text-white drop-shadow-xl" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.8)' }}>Building Solutions:</span>
                
                {/* Dynamic rotating text - Enhanced visibility */}
                <span className="block text-white drop-shadow-xl text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl mt-4 min-h-[1.2em]" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.8)' }}>
                  Your partner in{' '}
                  <span 
                    className="text-primary-blue font-bold inline-block min-w-[280px] text-left"
                    style={{ textShadow: '3px 3px 8px rgba(0,0,0,0.9), 0 0 20px rgba(26, 117, 149, 0.5)' }}
                  >
              ...
              <p className="text-lg xl:text-xl 2xl:text-2xl text-white leading-relaxed max-w-4xl mx-auto drop-shadow-lg" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                Leading data science and technology consultancy empowering organizations across Kenya and East Africa 
                to unlock insights, drive innovation, and achieve sustainable growth through cutting-edge solutions.
              </p>
              ...
              <div className="grid grid-cols-3 gap-8 xl:gap-12 pt-8 border-t border-white/40 max-w-2xl mx-auto">
                <div className="text-center">
                  <div className="text-3xl xl:text-4xl 2xl:text-5xl font-bold text-white drop-shadow-xl" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>100+</div>
                  <div className="text-sm xl:text-base text-gray-100 drop-shadow-md" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.7)' }}>Projects</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl xl:text-4xl 2xl:text-5xl font-bold text-white drop-shadow-xl" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>50+</div>
                  <div className="text-sm xl:text-base text-gray-100 drop-shadow-md" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.7)' }}>Clients</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl xl:text-4xl 2xl:text-5xl font-bold text-white drop-shadow-xl" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>5+</div>
                  <div className="text-sm xl:text-base text-gray-100 drop-shadow-md" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.7)' }}>Years</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="text-center mb-12 xl:mb-16">
            ...
            <p className="text-lg xl:text-xl 2xl:text-2xl text-muted-foreground max-w-4xl mx-auto">
              We're proud to work with leading organizations across Kenya and East Africa, delivering impactful solutions that drive real change.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-6 2xl:grid-cols-6 gap-6 xl:gap-8 2xl:gap-10 max-w-7xl mx-auto">
            {partners.map((partner, index) => (
              <div key={index} className="group text-center">
                ...
                <h4 className="font-semibold text-sm xl:text-base text-center mb-1">{partner.name}</h4>
                <p className="text-xs xl:text-sm text-muted-foreground text-center">{partner.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 xl:py-20 2xl:py-24 bg-gradient-to-br from-light-blue/20 to-primary-blue-lighter/20">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="text-center mb-12 xl:mb-16">
            ...
            <p className="text-lg xl:text-xl 2xl:text-2xl text-muted-foreground max-w-4xl mx-auto">
              Comprehensive data solutions designed to unlock insights, drive innovation, and accelerate your business growth.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-8 xl:gap-12 2xl:gap-16 max-w-7xl mx-auto">
            {services.map((service, index) => (
              <Card key={index} className="group overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 bg-white">
                ...
                <CardContent className="p-6 xl:p-8 2xl:p-10">
                  <CardTitle className="text-xl xl:text-2xl 2xl:text-3xl mb-4 text-primary-blue">{service.title}</CardTitle>
                  ...
                  <div className="grid grid-cols-2 gap-3 xl:gap-4">
                    {service.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center">
                        ...
                        <span className="text-sm xl:text-base text-muted-foreground">{feature}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
      ...
      <section className="py-16 xl:py-20 2xl:py-24 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="text-center mb-12 xl:mb-16">
            ...
            <p className="text-lg xl:text-xl 2xl:text-2xl text-muted-foreground max-w-4xl mx-auto">
              Meet the visionary leaders driving Statsspeak's mission to transform Africa through data intelligence.
            </p>
          </div>
              ...
              <Card key={index} className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                ...
                <CardContent className="p-6 xl:p-8 2xl:p-10">
                  <div className="text-center mb-6">
                    <h3 className="text-xl xl:text-2xl 2xl:text-3xl font-bold mb-2">{director.name}</h3>
                    <p className="text-primary-blue font-semibold text-base xl:text-lg 2xl:text-xl">{director.role}</p>
                  </div>
                  <p className="text-muted-foreground leading-relaxed mb-6 text-sm xl:text-base 2xl:text-lg">
                    {director.bio}
                  </p>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-primary-blue text-sm xl:text-base">Specialties:</h4>
                    <div className="flex flex-wrap gap-2">
                      {director.specialties.map((specialty, specialtyIndex) => (
                        <span key={specialtyIndex} className="px-3 py-1 bg-light-blue text-primary-blue rounded-full text-xs xl:text-sm">
                          {specialty}
                        </span>
                      ))}
                    </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="grid md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-8 xl:gap-12 2xl:gap-16 max-w-7xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-xl bg-white relative">
                <CardContent className="p-6 xl:p-8 2xl:p-10">
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 xl:h-6 xl:w-6 text-yellow-400 fill-current" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <div className="font-semibold text-base xl:text-lg 2xl:text-xl">{testimonial.author}</div>
                      <div className="text-primary-blue font-medium text-sm xl:text-base">{testimonial.role}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-8 xl:gap-12 2xl:gap-16 max-w-7xl mx-auto">
            <Card className="border-0 shadow-lg text-center p-6 xl:p-8 2xl:p-10 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-lg xl:text-xl 2xl:text-2xl font-semibold mb-4">Trusted Expertise</h3>
              <p className="text-muted-foreground text-sm xl:text-base 2xl:text-lg">Proven track record with government agencies and leading organizations across Africa.</p>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center p-6 xl:p-8 2xl:p-10 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-lg xl:text-xl 2xl:text-2xl font-semibold mb-4">Measurable Results</h3>
              <p className="text-muted-foreground text-sm xl:text-base 2xl:text-lg">Data-driven solutions that deliver quantifiable business impact and ROI.</p>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center p-6 xl:p-8 2xl:p-10 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-lg xl:text-xl 2xl:text-2xl font-semibold mb-4">Local Understanding</h3>
              <p className="text-muted-foreground text-sm xl:text-base 2xl:text-lg">Deep understanding of African markets, challenges, and opportunities.</p>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center p-6 xl:p-8 2xl:p-10 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-lg xl:text-xl 2xl:text-2xl font-semibold mb-4">Global Standards</h3>
              <p className="text-muted-foreground text-sm xl:text-base 2xl:text-lg">International best practices combined with local expertise and insights.</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 xl:py-20 2xl:py-24 bg-gradient-to-r from-primary-blue to-medium-blue">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center">
          ...
          <p className="text-lg xl:text-xl 2xl:text-2xl text-primary-blue-light mb-8 max-w-3xl mx-auto">
            Join leading organizations across Africa who trust Statsspeak to unlock insights, drive innovation, and achieve sustainable growth.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 xl:gap-6 justify-center">
            <Button 
              size="lg"
