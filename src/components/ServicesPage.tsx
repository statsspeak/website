  ...
  const services = [
    {
      ...
      description: 'Transform your raw data into actionable business insights with our comprehensive data science solutions.',
    ...
    },
    {
      ...
      description: 'Build robust, scalable data infrastructure that powers your organization\'s analytical capabilities.',
      ...
      technologies: ['Apache Spark', 'Kafka', 'Airflow', 'AWS', 'Azure', 'Docker'],
      benefits: [
    ...
    },
    {
      ...
      technologies: ['React', 'Node.js', 'Python', 'PostgreSQL', 'MongoDB', 'Kubernetes'],
      benefits: [
        'Custom solutions',
        'Improved efficiency',
    ...
    },
    {
      ...
      description: 'Leverage location intelligence and spatial analysis to solve complex geographical challenges.',
      ...
      technologies: ['QGIS', 'ArcGIS', 'PostGIS', 'Leaflet', 'GDAL', 'OpenLayers'],
      benefits: [
  ...
  const processSteps = [
    {
      ...
      description: 'We start by understanding your business goals, current challenges, and data landscape.'
    },
    {
      step: '02',
      title: 'Strategy & Planning',
      description: 'Develop a comprehensive roadmap with clear timelines, milestones, and success metrics.'
    },
    {
      step: '03',
      title: 'Development & Implementation',
      description: 'Build and deploy solutions using industry best practices and cutting-edge technologies.'
    },
    {
      step: '04',
    ...
    },
    {
      ...
      description: 'Smooth deployment with ongoing support and maintenance to ensure continued success.'
    }
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Comprehensive data solutions designed to unlock insights, drive innovation, and accelerate your business growth across Kenya and East Africa.
            </p>
          </div>
        </div>
      </section>
            ...
            {services.map((service, index) => (
              <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <div className="mb-6">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-sky-blue">{service.title}</h2>
                  ...
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Key Features</h3>
                  ...
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Technologies</h3>
                    <div className="flex flex-wrap gap-2">
                      {service.technologies.map((tech, techIndex) => (
                        <Badge key={techIndex} className="bg-light-blue text-sky-blue hover:bg-sky-blue hover:text-white px-3 py-1">
                          {tech}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Key Benefits</h3>
                    <div className="grid md:grid-cols-2 gap-3">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            {processSteps.map((step, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-3 text-sky-blue-dark">{step.title}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg text-center p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Fast Delivery</h3>
              <p className="text-muted-foreground">Agile development process ensuring rapid time-to-market without compromising quality.</p>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Security First</h3>
              <p className="text-muted-foreground">Enterprise-grade security measures to protect your data and maintain compliance.</p>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-sky-blue-dark">Expert Team</h3>
              <p className="text-muted-foreground">Experienced professionals with deep expertise in data science and engineering.</p>
            </Card>
          </div>
        </div>
      </section>
